        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExperienceYears = table.Column<decimal>(type: "numeric(4,1)", precision: 4, scale: 1, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_saved_jobs", x => new { x.CandidateId, x.JobId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_application_status_histories_ChangedAt",
                table: "application_status_histories",
                column: "ChangedAt");
